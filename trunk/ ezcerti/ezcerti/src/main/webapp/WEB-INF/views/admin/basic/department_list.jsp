...
function paging(currentPage){
	...
	f.action = '/muniv/basic/department_list';
	f.submit();
}
</script>
</head>
...
<div id="contents">
	...
	<div class="titlebg">
	  <table width="670" border="0" cellpadding="0" cellspacing="0" >
	    <tr>
	      <td width="320" height="75" align="left" valign="bottom"><img src="/resources/images/admin/sub_basics_title_03.png"  alt="학과정보타이틀" /></td>
	      <td width="340" align="right" valign="bottom"><img src="/resources/images/admin/home_icon.png" width="22" height="12" alt="홈아이콘" /> &nbsp;기초정보&nbsp;<img src="/resources/images/admin/small_arrow_icon.png" width="4" height="12" alt="화살표" /> &nbsp;학과정보 </td>
	    </tr>
	  </table>
	</div>
	<br />
	  ...
	  <tr>
	    <td align="center"><table width="690" border="0" cellspacing="0" cellpadding="0">
	      <tr>
	        ...
	        <td width="167" align="center" valign="middle" class="tdgray">단과</td>
	        <td width="152" align="center" valign="middle" class="tdgray">학과코드</td>
	        <td width="157" align="center" valign="middle" class="tdgray">학과명</td>
	      ...
	      <tr>
	        ...
	        <td class="tdwhite">${b.dept_name }</td>
	...
	<!-- 검색 -->
	  <tr>
		...
		<form id="searchForm" method="get" action="/muniv/basic/department_list" autocomplete="off">
