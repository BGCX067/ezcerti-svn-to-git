...
public class Admin {
	...
	public Admin(String row_no, String univ_cd, String coll_cd, String dept_cd,
			String admin_no, String coll_name, String dept_name,
			String admin_name, String admin_passwd, String hp_no,
			String email_addr, String photo_info, String admin_level_cd,
			String admin_sts_cd, String admin_nick_name, Date log_end_date,
			String authority, String reg_type_cd, String reg_etc, Date reg_date) {
		super();
		this.row_no = row_no;
	...
	public String toString() {
		return "Admin [row_no=" + row_no + ", univ_cd=" + univ_cd
				+ ", coll_cd=" + coll_cd + ", dept_cd=" + dept_cd
				+ ", admin_no=" + admin_no + ", coll_name=" + coll_name
				+ ", dept_name=" + dept_name + ", admin_name=" + admin_name
				+ ", admin_passwd=" + admin_passwd + ", hp_no=" + hp_no
				+ ", email_addr=" + email_addr + ", photo_info=" + photo_info
				+ ", admin_level_cd=" + admin_level_cd + ", admin_sts_cd="
				+ admin_sts_cd + ", admin_nick_name=" + admin_nick_name
				+ ", log_end_date=" + log_end_date + ", authority=" + authority
